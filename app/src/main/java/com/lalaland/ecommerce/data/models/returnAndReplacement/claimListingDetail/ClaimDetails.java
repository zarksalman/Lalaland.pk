...
public class ClaimDetails {
    ...
    @SerializedName("customer_reason")
    @Expose
    private String customerReason;
    @SerializedName("customer_reason_detail")
    @Expose
    private String customerReasonDetail;
    ...
    public String getCustomerReasonDetail() {
        return customerReasonDetail;
    }

    public void setCustomerReasonDetail(String customerReasonDetail) {
        this.customerReasonDetail = customerReasonDetail;
    }
