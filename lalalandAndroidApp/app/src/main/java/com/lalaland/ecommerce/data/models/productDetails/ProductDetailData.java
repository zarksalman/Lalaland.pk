...
public class ProductDetailData {
    ...
    @SerializedName("linked_product_by_category")
    @Expose
    private LinkedProductByCategory linkedProductByCategory;
    ...
    public void setLinkedProductByCategory(LinkedProductByCategory linkedProductByCategory) {
        this.linkedProductByCategory = linkedProductByCategory;
    }

    public LinkedProductByCategory getLinkedProductByCategory() {
        return linkedProductByCategory;
    }
}